...
export default {
    ...
    detail_show2(id){
        ...
        console.log("id:", id)
        return instance.get(`/detail2/${id}`, {
            id: id
        });
    },

    detail_new(title, content, editor){
    ...
    detail_delete(id){
        return instance.delete(`/detail2/${id}`, {
        });
    },
    ...
    reject_client(clientId){
        return instance.delete(`/detail/${clientId}`, {
        });
    }
}
