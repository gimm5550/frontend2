...
const MIN_ZOOM_FOR_MARKERS = 18; // 마커를 표시하기 위한 최소 줌 레벨
        ...
        <div style={{ height: "100vh", width: "100%", display: "flex", flexDirection: "column" }}>
            ...
            >
                {isLoaded && (
                    ...
                    <div style={{ width: "75px" }}> {/* 기존 크기에서 절반으로 줄임 */}
                        <h5 style={{ fontSize: "12px", margin: "5px 0" }}>{place.name}</h5>
                        <p style={{ fontSize: "10px", margin: "5px 0" }}>{place.vicinity}</p>
