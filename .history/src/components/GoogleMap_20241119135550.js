    ...
    const fetchTouristConcentrationInfo = async (areaCd, sigunguCd, tAtsNm) => {
        ...
        try {
            ...
            const response = await fetch(
                `http://apis.data.go.kr/B551011/TatsCnctrRateService/tatsCnctrRatedList?serviceKey=${service_key}&numOfRows=30&pageNo=1&MobileOS=ETC&MobileApp=AppTest&areaCd=${areaCd}&signguCd=${sigunguCd}&tAtsNm=간현관광지&_type=json`
            );
