...
export default function GoogleMapPage() {
    ...
    const submitPost = () => {
        ...
        if (file) {
            alert(`Post submitted with text: "${content}" and file: "${file.name}"`);
        } else {
            alert(`Post submitted with text: "${content}" but no file uploaded.`);
        }

        // Add your logic to handle form data, such as sending it to a server
    };
