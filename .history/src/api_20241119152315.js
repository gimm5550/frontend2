...
export default {
    ...
    PostPolyLine(payload) {
        return instance.post('/api/polyline', payload);
    },
    getMyTreavel(userId){
    ...
    postcomment2(newComment, author, polylineId) {
        return instance.post(`/api/polyline/${polylineId}/comments`, { newComment : newComment, author : author });
    },
}
