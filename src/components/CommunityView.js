...
export default function CommunityView() {
    ...
    const handleCommentSubmit = async () => {
        ...
        console.log("id, communityId, nickname, newComment:", id, communityId, nickname, newComment)
        try {
            // 새 댓글 추가 API 호출
            const response = await api.add_comment(id, communityId, nickname, newComment);
